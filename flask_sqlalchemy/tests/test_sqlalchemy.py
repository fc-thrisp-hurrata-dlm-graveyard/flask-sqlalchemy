...
class BasicAppTestCase(unittest.TestCase):
    ...
    def test_query_recording(self):
        with self.app.test_request_context():
            ...
            queries = sqlalchemy.flask_sqlalchemy.get_debug_queries()
...
class SignallingTestCase(unittest.TestCase):
    ...
    def test_model_signals(self):
        ...
        with sqlalchemy.flask_sqlalchemy.models_committed.connected_to(committed,
                                                      sender=self.app):
...
class PaginationTestCase(unittest.TestCase):
    ...
    def test_basic_pagination(self):
        p = sqlalchemy.flask_sqlalchemy.Pagination(None, 1, 20, 500, [])
